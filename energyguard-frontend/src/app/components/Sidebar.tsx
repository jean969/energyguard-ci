...
export function Sidebar({ currentPage, onPageChange }: SidebarProps) {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      name: "Carte",
      icon: Map,
      description: "Risques & flux"
    },
    {
      id: "minigrids",
      name: "Mini-réseaux",
      icon: Sun,
      description: "Zones rurales"
    },
    {
      id: "environment",
      name: "Impact",
      icon: Leaf,
      description: "CO₂ & environnement"
    },
    {
      id: "demo",
      name: "Démo live",
      icon: PlayCircle,
      description: "Coupure évitée"
    },
    {
      id: "analytics",
      name: "Analytique",
      icon: BarChart3,
      description: "Par zone & appareil"
    },
    {
      id: "configuration",
      name: "Configuration",
